...
{           
    ...
    float attenuation = min(vision_coeff * 10.0f / (distance * distance),1.0);
    vec3 lighting = (ambient + diffuse + specular) * attenuation * 2.0 * lightColor;
